    ...
    <div className="bg-gradient-to-bl from-purple via-blue to-blue w-full px-4 md:px-10 py-6">
      <div className="flex items-center justify-between w-full">
        <div className="w-6/12 md:w-4/12">
          <img src="./assets/Home/challenge.png" alt="challenge" />
        </div>
        <div className="flex">
          <Link to="/">
          ...
          <a href="mailto:studentsupport@kiit.ac.in?subject=Enquiry - KSTAR" target="_blank"
            rel="noreferrer" className="flex font-bold items-center ml-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="43.464"
              height="43.463"
